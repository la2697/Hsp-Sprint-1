...
namespace Berechnung_von_Zahnrädern{
    class Program{
        ...
        static void Main(string[] args){
            ...
            switch (eingabe){
                case 1:
                    Console.WriteLine("\nZahnfußhöhe mit Standardkopfspiel in mm:               " + Math.Round(m + c) + "mm");
                    Console.WriteLine("\nFußkreisdurchmesser mit Standardkopfspiel in mm:       " + Math.Round(m * z) + 2 * (m + c) + "mm");
                    Console.WriteLine("\nZahnhöhe mit Standardkopfspiel in mm:                  " + Math.Round(2*m+c) + "mm");
                    break;

                case 2:
                    Console.WriteLine("\nZahnfußhöhe mit Kopfspiel 0.1 DIN 867 in mm:           " + Math.Round(m + c1) + "mm");
                    Console.WriteLine("\nFußkreisdurchmesser mit Kopfspiel 0.1 DIN 867 in mm:   " + Math.Round(m * z) + 2 * (m + c1) + "mm");
                    Console.WriteLine("\nZahnhöhe mit Kopfspiel 0.1 DIN 867 in mm:              " + Math.Round(2 * m + c1) + "mm");
                    break;

                case 3:
                    Console.WriteLine("\nZahnfußhöhe mit Kopfspiel 0.3 DIN 867 in mm:           " + Math.Round(m + c2) + "mm");
                    Console.WriteLine("\nFußkreisdurchmesser mit Kopfspiel 0.3 DIN 867 in mm:   " + Math.Round(m * z) + 2 * (m + c2) + "mm");
                    Console.WriteLine("\nZahnhöhe mit Kopfspiel 0.3 DIN 867 in mm:              " + Math.Round(2 * m + c2) + "mm");
                    break;
            }

            Console.WriteLine("\nTeilung der Zähne am Zahnrad in mm:                    " + Math.Round(Pi * m) + "mm");
            Console.WriteLine("\nGrundkreisdurchmesser des Zahnrades in mm:             " + Math.Round(m * z * cosα) + "mm");
